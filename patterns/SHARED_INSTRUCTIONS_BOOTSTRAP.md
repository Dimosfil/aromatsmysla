...
РёРЅРёС‚ [Dimosfil/general-instructions.git](https://github.com/Dimosfil/general-instructions.git)
```
...
```text
РћР±РЅРѕРІРёСЃСЊ РёР· https://github.com/Dimosfil/general-instructions.git
```
